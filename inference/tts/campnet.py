...
class StutterSpeechInfer(BaseTTSInfer):
    ...
    def example_run(cls):
        ...
        set_hparams()
        wav2spec_res = librosa_wav2spec('inference/audio/2.wav', fmin=55, fmax=7600, sample_rate=22050)
        inp = {
            'text': 'It\'s a nice day when I take Trump to the zoo.',
